...
class Train_GD_Wiring_Post:
    ...
    def train_one_iter(self):
        ...
        fixed_stick1_np = np.ones((self.args.n_envs, self.stick1.n_vertices), dtype=bool)
        self.stick1.set_fixed(0, fixed_stick1_np)
        fixed_stick2_np = np.ones((self.args.n_envs, self.stick2.n_vertices), dtype=bool)
...
def main():
    ...
    trainer = Train_GD_Wiring_Post(args)
    trainer.train()
