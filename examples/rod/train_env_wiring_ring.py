        ...
        for i in range(n_steps):
            ...
            for j in range(n_steps_sub):
                ...
                if not_able_to_trans12.any():
                    first_fail_step[not_able_to_trans12] = np.minimum(first_fail_step[not_able_to_trans12], global_step)
                ...
                if not_able_to_trans23.any():
                    first_fail_step[not_able_to_trans23] = np.minimum(first_fail_step[not_able_to_trans23], global_step)
